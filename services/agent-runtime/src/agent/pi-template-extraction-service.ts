...
const TEMPLATE_RETURN_PARAMETERS = Type.Object({
  ...
  markdown: Type.String({ minLength: 1, maxLength: 32_768 }),
  styleProfile: Type.Optional(Type.Object({
    tone: Type.Optional(Type.String({ maxLength: 4_000 })),
    audience: Type.Optional(Type.String({ maxLength: 4_000 })),
    perspective: Type.Optional(Type.String({ maxLength: 4_000 })),
    sentenceStyle: Type.Optional(Type.String({ maxLength: 4_000 })),
    pacing: Type.Optional(Type.String({ maxLength: 4_000 })),
    density: Type.Optional(Type.String({ maxLength: 4_000 })),
  })),
  structureProfile: Type.Optional(Type.Object({
    openingPattern: Type.Optional(Type.String({ maxLength: 4_000 })),
    sectionPattern: Type.Optional(Type.String({ maxLength: 4_000 })),
    conclusionPattern: Type.Optional(Type.String({ maxLength: 4_000 })),
    headingDepth: Type.Optional(Type.String({ maxLength: 4_000 })),
    paragraphPattern: Type.Optional(Type.String({ maxLength: 4_000 })),
  })),
  layoutProfile: Type.Optional(Type.Object({
    ...
    imagePlacement: Type.Optional(Type.String({ maxLength: 4_000 })),
    emphasisRules: Type.Optional(Type.String({ maxLength: 4_000 })),
  })),
  variables: Type.Optional(Type.Array(Type.String({ pattern: "^[a-z][a-z0-9_]*$" }), { maxItems: 64 })),
  usageInstructions: Type.Optional(Type.String({ maxLength: 4_000 })),
